<div class="import-popup popup stage-1" id="import-popup" style="display:none">
  <div class="import-popup__cnt popup__cnt">
    ...
    <form action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" enctype="multipart/form-data" id="import-form-block">
      <div class="import-popup__select-block">
        ...
        <select name="post_type" id="import-select">
      ...
      <button class="btn btn_blue" id="import-btn">Отправить</button>
    </form>
    <!-- <div class="loader">
        ...
        xhr.addEventListener('readystatechange', function() {
          if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            if (!totalPosts) {
              ...
              console.log('Осталось: ' + totalPosts);
            }
